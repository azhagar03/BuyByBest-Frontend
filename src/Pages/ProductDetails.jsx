...
const ProductDetailsPage = ({ product, onNavigate, onAddToCart }) => {
  ...
  const loadLiveProduct = async () => {
    try {
      const res = await fetch(`https://buybybest-backend-0khu.onrender.com/products/${product._id}`);
      if (res.ok) {
  ...
  const loadRelatedProducts = async () => {
    try {
      const res = await fetch("https://buybybest-backend-0khu.onrender.com/products");
      const data = await res.json();
      const related = data
  ...
  const loadReviews = async () => {
    try {
      const res = await fetch(`https://buybybest-backend-0khu.onrender.com/reviews/${product._id}`);
      const data = await res.json();
  ...
  const handleSubmitReview = async () => {
    ...
    try {
      const res = await fetch("https://buybybest-backend-0khu.onrender.com/reviews", {
        method: "POST",
